        ...
        <div className=" text-black">
          <div className="py-10 text-center w-1/2 mx-auto">
            ...
            >
              ...
              <div className="w-4/5 mx-auto text-left py-4">
                ...
                <div className="my-4 flex items-center gap-4">
                  <input
                    type="checkbox"
                    className="relative w-[1.7rem] h-[1.2rem]"
                    name=""
                    id=""
                  />
                  <p className="text-sm">
                    Share my registration data with jio saavn's content providers
                    for marketing purposes.
                  </p>
                </div>
                <p className="my-4 text-xs">
                  By clicking on sign-up, you agree to{" "}
                  <Link to="/" className="text-[#31c2b4]">
                    jio saavn's Terms and Condition
                  </Link>{" "}
                  of Use.
                </p>
                <p className="my-4 text-xs">
                  To learn more about how jio saavn collects, uses, shares and
                  protects your personal data, please see &nbsp;
                  <Link to="/" className="text-[#31c2b4]">
                    jio saavn's Privacy Policy.
                  </Link>{" "}
                </p>
              </div>
              ...
              <div className="w-full text-left py-4">
                <input
                  type="submit"
                  value="Sign up"
                  className="block cursor-pointer w-1/2 mx-auto outline-none bg-[#31c2b4] text-black p-3 hover:scale-105 translate-all duration-200 font-medium hover:font-semibold text-center rounded-full "
                />
              </div>
            </form>
            ...
            <p className="pt-8">
              ...
              <Link
                to="/login"
                className="text-[#31c2b4] hover:text-[#31c2b4]/90 font-semibold underline mx-auto"
              >
                Log in
              </Link>
            </p>
